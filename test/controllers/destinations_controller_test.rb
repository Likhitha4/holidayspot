...
class DestinationsControllerTest < ActionController::TestCase
  ...
  test "should create destination" do
    assert_difference('Destination.count') do
      post :create, destination: { city_id: @destination.city_id, latitude: @destination.latitude, longitude: @destination.longitude, title: @destination.title }
    end
  ...
  test "should update destination" do
    patch :update, id: @destination, destination: { city_id: @destination.city_id, latitude: @destination.latitude, longitude: @destination.longitude, title: @destination.title }
    assert_redirected_to destination_path(assigns(:destination))
  end
